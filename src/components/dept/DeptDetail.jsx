...
const DeptDetail = ({imageUploader}) => {
	...
	//리액트에서는 메모이제이션 컨벤션
	//useMemo와 useCallback - 첫번째 파라미터 함수가 두번째 파라미터 의존성배열임
	...
	const deptUpdate = async () => {
		...
		if(!res.data){
			...
			//성공시 부서목록 새로고침 처리할것 - window.location.reload()쓰지 말것 - SPA 컨벤션
		...
		<>
			...
			<div className="page-header">
				...
				<Modal show={show} onHide={handleClose} animation={false}>
					...
					<div style={{ display:'flex' }}>
						<MyLabel>지역 <span style={{color:'red'}}>{star.dname}</span>
