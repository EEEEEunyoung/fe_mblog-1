...
import DeptRow from "../components/dept/DeptRow";
import { MyInput, MyLabel, MyLabelAb } from "../components/styles/FormStyle";
          ...
          <div style={{display:'flex', flexWrap:'wrap', justifyContent:'center' }}>
            <div style={{display:'flex'}}>
              ...
              <MyInput type="text" name="deptno" placeholder="Enter 부서번호"
                onChange={(e) => {handleDeptno(e.target.value);}} />
            ...
            <div style={{display:'flex'}}>
              ...
              <MyInput type="text" name="dname" placeholder="Enter 부서명"
                onChange={(e) => {handleDname(e.target.value);}} />
            ...
            <div style={{display:'flex'}}>
              ...
              <MyInput type="text" name="loc" placeholder="Enter 지역"
